...
using Microsoft.Identity.GitCredentialManager.Commands;
using Microsoft.Identity.GitCredentialManager.Controls;

namespace Microsoft.Identity.GitCredentialManager
{
    public static class Program
    {
        ...
        private static void AppMain(object o)
        {
            ...
            {
                app.RegisterCommand(new MicrosoftAccountPickerCommandImpl(context));

...
namespace GitHub.UI.Controls
{
    public class TesterWindow : Window
    {
        ...
        {
            string userCode = this.FindControl<TextBox>("deviceCode").Text;
            string verificationUrl = this.FindControl<TextBox>("verificationUrl").Text;

            var vm = new DeviceCodeViewModel(_environment, userCode, verificationUrl);

...
using Microsoft.AzureRepos.UI.Commands;
using Microsoft.AzureRepos.UI.Controls;

namespace Microsoft.AzureRepos.UI
{
    public static class Program
    {
        ...
        private static void AppMain(object o)
        {
            ...
            {
                app.RegisterCommand(new AccountPickerCommandImpl(context));

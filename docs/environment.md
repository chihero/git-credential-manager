...
```batch
SET GCM_GITHUB_OAUTH_SCOPES="read:packages,codespace"
```

##### macOS/Linux

```bash
export GCM_GITHUB_OAUTH_SCOPES="read:packages,codespace"
```

**Also see: [credential.gitHubOAuthScopes](configuration.md#credentialgitHubOAuthScopes)**

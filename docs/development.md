...
You can find a copy of the installer .exe files and zip archives in `out\windows\Installer.Windows\pkg\Debug\net472\<runtime>\`.

The flat binaries can also be found in `out\windows\Installer.Windows\bin\Debug\net472\<runtime>\payload\`.
